...
//    StructLayout SIG_LAYOUT = MemoryLayout.structLayout(
//            MemoryLayout.sequenceLayout(32, secp256k1_h.C_CHAR).withName("r"),
//            MemoryLayout.sequenceLayout(32, secp256k1_h.C_CHAR).withName("s")
