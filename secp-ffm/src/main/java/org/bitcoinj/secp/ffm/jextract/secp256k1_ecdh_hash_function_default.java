...
public final class secp256k1_ecdh_hash_function_default {
    ...
    private static final MethodHandle UP$MH = secp256k1_h.upcallHandle(secp256k1_ecdh_hash_function_default.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(secp256k1_ecdh_hash_function_default.Function fi, Arena arena) {
