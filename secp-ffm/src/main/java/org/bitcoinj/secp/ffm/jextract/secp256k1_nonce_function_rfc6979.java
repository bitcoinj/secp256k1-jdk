 ...
 * }
 */
public final class secp256k1_nonce_function_rfc6979 {

    private secp256k1_nonce_function_rfc6979() {
    ...
    private static final MethodHandle UP$MH = secp256k1_h.upcallHandle(secp256k1_nonce_function_rfc6979.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(secp256k1_nonce_function_rfc6979.Function fi, Arena arena) {
