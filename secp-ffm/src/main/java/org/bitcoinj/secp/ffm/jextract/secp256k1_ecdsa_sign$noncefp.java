...
public class secp256k1_ecdsa_sign$noncefp {
    ...
    private static final MethodHandle UP$MH = secp256k1_h.upcallHandle(secp256k1_ecdsa_sign$noncefp.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(secp256k1_ecdsa_sign$noncefp.Function fi, Arena arena) {
