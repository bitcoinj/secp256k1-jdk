...
/**
 * @deprecated Use {@link SPKeyPair}  (@code P256K1KeyPair#P256K1KeyPairImpl}
 */
@Deprecated
class OpaqueKeyPair implements SPKeyPair {
    ...
    public SPPubKey getPublic() {
        ...
        return new SPPubKeyImpl(pubKeyPoint);
    }
    ...
    public SPPrivKey getPrivate() {
        return SPPrivKey.of(getEncoded());
    }
