...
The API is distributed as an API-only JAR (```secp-api-_version_.jar```) and there are multiple implementations of the API. `secp-api` requires JDK 9 or later.

For details see the https://msgilligan.github.io/javadoc/secp256k1-jdk/0.2.3[Javadoc].
...
----
dependencies {
    implementation "org.bitcoinj.secp:secp-api:0.2.3"
}
----
...
The new Maven build requires Maven 3.9.0 or later.
