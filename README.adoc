...
The build requires JDK 23 installed to run. Gradle 8.12.1 should be used and is provided by the included Gradle Wrapper.
...
Make sure you have installed version (0.6.0) of `secp256k1` with `nix profile install nixpkgs#secp256k1`
