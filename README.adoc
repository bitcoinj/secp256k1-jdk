...
For details see the https://msgilligan.github.io/javadoc/secp256k1-jdk/{secp-jdk-version}[Javadoc].
...
<dependency>
  ...
  <version>{secp-jdk-version}</version>
</dependency>
----
...
----
dependencies {
    implementation "org.bitcoinj.secp:secp-api:{secp-jdk-version}"
}
----
