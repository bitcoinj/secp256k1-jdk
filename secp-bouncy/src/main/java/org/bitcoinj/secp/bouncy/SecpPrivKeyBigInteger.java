...
/**
 * Private key implementation that stores the private key as
 * a {@link BigInteger}.
 */
public class SecpPrivKeyBigInteger implements SecpPrivKey {
    private @Nullable BigInteger privKey;

    public SecpPrivKeyBigInteger(BigInteger privKey) {
