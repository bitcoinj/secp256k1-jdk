 ...
 * }
 */
public interface secp256k1_nonce_function_rfc6979 {
    ...
    static MemorySegment allocate(secp256k1_nonce_function_rfc6979 fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$6.const$1, fi, constants$0.const$2, scope);
    }
    static secp256k1_nonce_function_rfc6979 ofAddress(MemorySegment addr, Arena arena) {
